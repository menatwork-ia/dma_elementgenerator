...
$GLOBALS['TL_DCA']['tl_dma_eg_fields'] = array(
    ...
    'palettes'    => array(
        ...
        'fileTree'          => '{type_legend},type,label,title,explanation;{input_legend},default_value,eval_mandatory,eval_extensions,eval_field_type,eval_path,eval_sortable;{style_legend},eval_tl_class;{subpalette_legend:hide},useCheckboxCondition;{expert_legend:hide},exclude,class,template',
